...
public class Usuario {
    ...
    public boolean addUser(User user) {
        ...
        try {
            ...
            conexion = PruebaConnection.pruebaConnection();// crea objeto conexion
            // con=PruebaConnection.getInstance.getConnection();//establece la conexión a la
            // bd
            ...
            if (conexion != null) {
                ...
                pst = ((Connection) conexion).prepareStatement(sql);
    ...
    public ArrayList<User> selectUser(String filter, ArrayList<String> data) {
        ...
        try {
            ...
            // "root");//establece la conexión a la bd
